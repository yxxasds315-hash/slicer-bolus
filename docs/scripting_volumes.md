...
- Volumes
- [Edit on GitHub](https://github.com/slicer/slicer/blob/main/Docs/developer_guide/script_repository/volumes.md)

* * *

# Volumes [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#volumes "Link to this heading")

## Load volume from file [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#load-volume-from-file "Link to this heading")
...
## Save volume to file [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#save-volume-to-file "Link to this heading")
...
## Load volume from .vti file [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#load-volume-from-vti-file "Link to this heading")
...
## Load volume from a remote server [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#load-volume-from-a-remote-server "Link to this heading")
...
again. To compute digest with algo _SHA256_, you can run `slicer.util.computeChecksum("SHA256", "path/to/file")()`.

### Simple download [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#simple-download "Link to this heading")
...
### Download with interruptible progress reporting [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#download-with-interruptible-progress-reporting "Link to this heading")
...
## Show volume rendering automatically when a volume is loaded [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#show-volume-rendering-automatically-when-a-volume-is-loaded "Link to this heading")

To show volume rendering of a volume automatically when it is loaded, add the lines below to your [.slicerrc.py file](https://slicer.readthedocs.io/en/latest/user_guide/settings.html#application-startup-file).
...
## Show volume rendering using maximum intensity projection [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#show-volume-rendering-using-maximum-intensity-projection "Link to this heading")
...
## Show volume rendering making soft tissues transparent [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#show-volume-rendering-making-soft-tissues-transparent "Link to this heading")
...
## Automatically load volumes that are copied into a folder [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#automatically-load-volumes-that-are-copied-into-a-folder "Link to this heading")
...
## Extract slice from volume [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#extract-slice-from-volume "Link to this heading")
...
## Extract randomly oriented slabs of given shape from a volume [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#extract-randomly-oriented-slabs-of-given-shape-from-a-volume "Link to this heading")
...
## Clone a volume [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#clone-a-volume "Link to this heading")
...
## Create a new volume [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#create-a-new-volume "Link to this heading")
...
## Create a new volume from ROI [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#create-a-new-volume-from-roi "Link to this heading")
...
## Get value of a volume at specific voxel coordinates [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#get-value-of-a-volume-at-specific-voxel-coordinates "Link to this heading")
...
## Modify voxels in a volume [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#modify-voxels-in-a-volume "Link to this heading")
...
## Get volume voxel coordinates from markup control point RAS coordinates [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#get-volume-voxel-coordinates-from-markup-control-point-ras-coordinates "Link to this heading")
...
## Get markup control point RAS coordinates from volume voxel coordinates [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#get-markup-control-point-ras-coordinates-from-volume-voxel-coordinates "Link to this heading")
...
## Get the values of all voxels for a label value [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#get-the-values-of-all-voxels-for-a-label-value "Link to this heading")
...
## Access values in a DTI tensor volume [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#access-values-in-a-dti-tensor-volume "Link to this heading")
...
## Change window/level (brightness/contrast) or colormap of a volume [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#change-window-level-brightness-contrast-or-colormap-of-a-volume "Link to this heading")
...
## Make mouse left-click and drag on the image adjust window/level [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#make-mouse-left-click-and-drag-on-the-image-adjust-window-level "Link to this heading")
...
## Reset field of view to show background volume maximized [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#reset-field-of-view-to-show-background-volume-maximized "Link to this heading")
...
## Rotate slice views to volume plane [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#rotate-slice-views-to-volume-plane "Link to this heading")
...
## Iterate over current visible slice views, and set foreground and background images [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#iterate-over-current-visible-slice-views-and-set-foreground-and-background-images "Link to this heading")
...
## Show a volume in slice views [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#show-a-volume-in-slice-views "Link to this heading")
...
## Change opacity of foreground volume in slice views [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#change-opacity-of-foreground-volume-in-slice-views "Link to this heading")
...
## Turning off interpolation [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#turning-off-interpolation "Link to this heading")
...
You can place this code snippet in your [.slicerrc.py file](https://slicer.readthedocs.io/en/latest/user_guide/settings.html#application-startup-file) to always disable interpolation by default.

## Running an ITK filter in Python using SimpleITK [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#running-an-itk-filter-in-python-using-simpleitk "Link to this heading")
...
- See the SimpleITK documentation for SimpleITK examples: [https://simpleitk.org/doxygen/latest/html/examples.html](https://simpleitk.org/doxygen/latest/html/examples.html)

- sitkUtils in Slicer is used for pushing and pulling images from Slicer to SimpleITK: [https://github.com/Slicer/Slicer/blob/main/Base/Python/sitkUtils.py](https://github.com/Slicer/Slicer/blob/main/Base/Python/sitkUtils.py)


## Get axial slice as numpy array [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#get-axial-slice-as-numpy-array "Link to this heading")
...
## Get reformatted image from a slice viewer as numpy array [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#get-reformatted-image-from-a-slice-viewer-as-numpy-array "Link to this heading")
...
## Combine multiple volumes into one [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#combine-multiple-volumes-into-one "Link to this heading")
...
## Add noise to image [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#add-noise-to-image "Link to this heading")
...
## Mask volume using segmentation [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#mask-volume-using-segmentation "Link to this heading")
...
## Apply random deformations to image [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#apply-random-deformations-to-image "Link to this heading")
...
[https://gist.github.com/lassoan/428af5285da75dc033d32ebff65ba940](https://gist.github.com/lassoan/428af5285da75dc033d32ebff65ba940)

## Thick slab reconstruction and maximum/minimum intensity volume projections [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#thick-slab-reconstruction-and-maximum-minimum-intensity-volume-projections "Link to this heading")
...
## Display volume using volume rendering [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#display-volume-using-volume-rendering "Link to this heading")
...
## Apply a custom volume rendering color/opacity transfer function [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#apply-a-custom-volume-rendering-color-opacity-transfer-function "Link to this heading")
...
## Limit volume rendering to a specific region of the volume [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#limit-volume-rendering-to-a-specific-region-of-the-volume "Link to this heading")
...
## Register a new Volume Rendering mapper [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#register-a-new-volume-rendering-mapper "Link to this heading")
...
## Register custom volume rendering presets [](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html\#register-custom-volume-rendering-presets "Link to this heading")
...
Versions**[latest](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository/volumes.html)**[5.10](https://slicer.readthedocs.io/en/5.10/developer_guide/script_repository/volumes.html)[5.8](https://slicer.readthedocs.io/en/5.8/developer_guide/script_repository/volumes.html)[5.6](https://slicer.readthedocs.io/en/5.6/developer_guide/script_repository/volumes.html)[5.4](https://slicer.readthedocs.io/en/5.4/developer_guide/script_repository/volumes.html)[5.2](https://slicer.readthedocs.io/en/5.2/developer_guide/script_repository/volumes.html)[5.0](https://slicer.readthedocs.io/en/5.0/developer_guide/script_repository/volumes.html)[v4.11](https://slicer.readthedocs.io/en/v4.11/developer_guide/script_repository/volumes.html)Downloads[PDF](https://slicer.readthedocs.io/_/downloads/en/latest/pdf/)[EPUB](https://slicer.readthedocs.io/_/downloads/en/latest/epub/)On Read the Docs[Project Home](https://app.readthedocs.org/projects/slicer/?utm_source=slicer&utm_content=flyout)[Builds](https://app.readthedocs.org/projects/slicer/builds/?utm_source=slicer&utm_content=flyout)Search
