...
- [Modules](https://slicer.readthedocs.io/en/latest/user_guide/modules/index.html)
  ...
  - [Segment editor](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#)
    - [How to cite](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#how-to-cite)
    - [Keyboard shortcuts](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#keyboard-shortcuts)
    - [Tutorials](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#tutorials)
    - [Panels and their use](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#panels-and-their-use)
      - [Main options](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#main-options)
      - [Segments table](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#segments-table)
      - [Effects section](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#effects-section)
      - [Masking options](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#masking-options)
    - [Effects](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#effects)
      - [Threshold](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#threshold)
      - [Paint](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#paint)
      - [Draw](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#draw)
      - [Erase](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#erase)
      - [Level Tracing](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#level-tracing)
      - [Grow from seeds](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#grow-from-seeds)
      - [Fill between slices](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#fill-between-slices)
      - [Margin](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#margin)
      - [Hollow](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#hollow)
      - [Smoothing](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#smoothing)
      - [Scissors](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#scissors)
      - [Islands](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#islands)
      - [Logical operators](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#logical-operators)
      - [Mask volume](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#mask-volume)
    - [Tips](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#tips)
    - [Frequently asked questions](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#frequently-asked-questions)
      - [Cannot paint outside some boundaries](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#cannot-paint-outside-some-boundaries)
      - [Cannot edit the segments](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#cannot-edit-the-segments)
      - [Segmentation is not accurate enough](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#segmentation-is-not-accurate-enough)
      - [Generated surface contains step artifacts](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#generated-surface-contains-step-artifacts)
      - [Paint affects neighbor slices or stripes appear in painted segments](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#paint-affects-neighbor-slices-or-stripes-appear-in-painted-segments)
    - [Limitations](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#limitations)
    - [Related Modules](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#related-modules)
    - [Information for Developers](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#information-for-developers)
    - [Contributors](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#contributors)
    - [Acknowledgements](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#acknowledgements)
  ...
  - [Wizards](https://slicer.readthedocs.io/en/latest/user_guide/modules/index.html#wizards)
  ...
  - [Segmentation](https://slicer.readthedocs.io/en/latest/user_guide/modules/index.html#segmentation)
    ...
    - [Segment editor](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#)
      ...
      - [Contributors](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#contributors)
      - [Acknowledgements](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#acknowledgements)
    - [Foreground masking (BRAINS)](https://slicer.readthedocs.io/en/latest/user_guide/modules/brainsroiauto.html)
...
- [Modules](https://slicer.readthedocs.io/en/latest/user_guide/modules/index.html)
- Segment editor
- [Edit on GitHub](https://github.com/slicer/slicer/blob/main/Docs/user_guide/modules/segmenteditor.md)

* * *

# Segment editor [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#segment-editor "Link to this heading")
...
Segment Editor does not edit labelmap volumes or models, but segmentations can be easily converted to/from labelmap volumes and models using the Import/Export section of [Segmentations](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmentations.html) module.

![](https://github.com/Slicer/Slicer/releases/download/docs-resources/image_segmentation_segment_editor_module.png)

## How to cite [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#how-to-cite "Link to this heading")

To cite the Segment Editor in scientific publications, you can cite [3D Slicer](https://slicer.readthedocs.io/en/latest/user_guide/about.html#how-to-cite) and the Segment Editor paper: _Cs. Pinter, A. Lasso, G. Fichtinger, “Polymorph segmentation representation for medical image computing”, Computer Methods and Programs in Biomedicine, Volume 171, p19-26, 2019_ ( [pdf](https://github.com/EBATINCA/EbatincaDoc/blob/477aae710a5f741b21edaca4838cf48fd4ea0220/Papers/Pinter2019_Manuscript.pdf), [DOI](https://doi.org/10.1016/j.cmpb.2019.02.011)). Additional references to non-trivial algorithms used in Segment Editor effects are provided below, in the documentation of each effect.

## Keyboard shortcuts [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#keyboard-shortcuts "Link to this heading")
...
## Tutorials [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#tutorials "Link to this heading")

- [Segmentation tutorials](https://training.slicer.org/#segmentation-tutorials)


## Panels and their use [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#panels-and-their-use "Link to this heading")

### Main options [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#main-options "Link to this heading")
...
### Segments table [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#segments-table "Link to this heading")
...
### Effects section [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#effects-section "Link to this heading")
...
### Masking options [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#masking-options "Link to this heading")
...
## Effects [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#effects "Link to this heading")
...
### ![](https://github.com/Slicer/Slicer/releases/download/docs-resources/module_segmenteditor_threshold.png) Threshold [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#threshold "Link to this heading")

Use Threshold to determine a threshold range and save results to selected segment or use it as Editable intensity range.

### ![](https://github.com/Slicer/Slicer/releases/download/docs-resources/module_segmenteditor_paint.png) Paint [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#paint "Link to this heading")
...
### ![](https://github.com/Slicer/Slicer/releases/download/docs-resources/module_segmenteditor_draw.png) Draw [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#draw "Link to this heading")
...
### ![](https://github.com/Slicer/Slicer/releases/download/docs-resources/module_segmenteditor_erase.png) Erase [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#erase "Link to this heading")
...
### ![](https://github.com/Slicer/Slicer/releases/download/docs-resources/module_segmenteditor_level_tracing.png) Level Tracing [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#level-tracing "Link to this heading")
...
### ![](https://github.com/Slicer/Slicer/releases/download/docs-resources/module_segmenteditor_grow_from_seeds.png) Grow from seeds [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#grow-from-seeds "Link to this heading")
...
### ![](https://github.com/Slicer/Slicer/releases/download/docs-resources/module_segmenteditor_fill_between_slices.png) Fill between slices [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#fill-between-slices "Link to this heading")
...
- The method uses _ND morphological contour interpolation algorithm_ described in this paper: [https://insight-journal.org/browse/publication/977](https://insight-journal.org/browse/publication/977)


### ![](https://github.com/Slicer/Slicer/releases/download/docs-resources/module_segmenteditor_margin.png) Margin [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#margin "Link to this heading")
...
### ![](https://github.com/Slicer/Slicer/releases/download/docs-resources/module_segmenteditor_hollow.png) Hollow [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#hollow "Link to this heading")
...
### ![](https://github.com/Slicer/Slicer/releases/download/docs-resources/module_segmenteditor_smoothing.png) Smoothing [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#smoothing "Link to this heading")
...
### ![](https://github.com/Slicer/Slicer/releases/download/docs-resources/module_segmenteditor_scissors.png) Scissors [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#scissors "Link to this heading")
...
### ![](https://github.com/Slicer/Slicer/releases/download/docs-resources/module_segmenteditor_islands.png) Islands [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#islands "Link to this heading")
...
### ![](https://github.com/Slicer/Slicer/releases/download/docs-resources/module_segmenteditor_logical_operators.png) Logical operators [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#logical-operators "Link to this heading")
...
### ![](https://github.com/Slicer/Slicer/releases/download/docs-resources/module_segmenteditor_mask_volume.png) Mask volume [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#mask-volume "Link to this heading")
...
## Tips [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#tips "Link to this heading")
...
## Frequently asked questions [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#frequently-asked-questions "Link to this heading")

### Cannot paint outside some boundaries [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#cannot-paint-outside-some-boundaries "Link to this heading")
...
### Cannot edit the segments [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#cannot-edit-the-segments "Link to this heading")
...
### Segmentation is not accurate enough [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#segmentation-is-not-accurate-enough "Link to this heading")
...
### Generated surface contains step artifacts [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#generated-surface-contains-step-artifacts "Link to this heading")
...
1. Choose spacing that allows accurate segmentation ( [see _Segmentation is not accurate enough_ section above](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html#segmentation-is-not-accurate-enough))
...
### Paint affects neighbor slices or stripes appear in painted segments [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#paint-affects-neighbor-slices-or-stripes-appear-in-painted-segments "Link to this heading")
...
## Limitations [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#limitations "Link to this heading")
...
## Related Modules [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#related-modules "Link to this heading")

- [Segment Statistics](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmentstatistics.html) module computes volume, surface, mean intensity, and various other metrics for each segment.

- [Segmentations](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmentations.html) module allows changing visualization options, exporting/importing segments to/from other nodes (models, labelmap volumes), and moving or copying segments between segmentation nodes.

- [Data](https://slicer.readthedocs.io/en/latest/user_guide/modules/data.html) module shows all segmentations and segments in a tree structure. Commonly used operations are available by right-clicking on an item in the tree.


## Information for Developers [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#information-for-developers "Link to this heading")

See examples for creating and modifying segmentation nodes and using segment editor effects from your own modules in [Developer guide](https://slicer.readthedocs.io/en/latest/developer_guide/modules/segmenteditor.html) and [Slicer script repository](https://slicer.readthedocs.io/en/latest/developer_guide/script_repository.html#segmentations)

## Contributors [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#contributors "Link to this heading")
...
## Acknowledgements [](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html\#acknowledgements "Link to this heading")
...
![](https://github.com/Slicer/Slicer/releases/download/docs-resources/logo_perklab.png)![](https://github.com/Slicer/Slicer/releases/download/docs-resources/logo_isomics.png)![](https://github.com/Slicer/Slicer/releases/download/docs-resources/logo_namic.png)![](https://github.com/Slicer/Slicer/releases/download/docs-resources/logo_nac.png)![](https://github.com/Slicer/Slicer/releases/download/docs-resources/logo_ge.png)

[Previous](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmentations.html "Segmentations") [Next](https://slicer.readthedocs.io/en/latest/user_guide/modules/slicerwelcome.html "Welcome")
...
Versions**[latest](https://slicer.readthedocs.io/en/latest/user_guide/modules/segmenteditor.html)**[5.10](https://slicer.readthedocs.io/en/5.10/user_guide/modules/segmenteditor.html)[5.8](https://slicer.readthedocs.io/en/5.8/user_guide/modules/segmenteditor.html)[5.6](https://slicer.readthedocs.io/en/5.6/user_guide/modules/segmenteditor.html)[5.4](https://slicer.readthedocs.io/en/5.4/user_guide/modules/segmenteditor.html)[5.2](https://slicer.readthedocs.io/en/5.2/user_guide/modules/segmenteditor.html)[5.0](https://slicer.readthedocs.io/en/5.0/user_guide/modules/segmenteditor.html)[v4.11](https://slicer.readthedocs.io/en/v4.11/user_guide/modules/segmenteditor.html)Downloads[PDF](https://slicer.readthedocs.io/_/downloads/en/latest/pdf/)[EPUB](https://slicer.readthedocs.io/_/downloads/en/latest/epub/)On Read the Docs[Project Home](https://app.readthedocs.org/projects/slicer/?utm_source=slicer&utm_content=flyout)[Builds](https://app.readthedocs.org/projects/slicer/builds/?utm_source=slicer&utm_content=flyout)Search
